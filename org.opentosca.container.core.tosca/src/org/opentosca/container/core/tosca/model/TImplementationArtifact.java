...
public class TImplementationArtifact extends TExtensibleElements {
     ...
     * Legt den Wert der name-Eigenschaft fest.
     *
     * @param attributeQName this QName has to be in the namespace for extending TOSCA due OpenTOSCA and
     *        with the local part "name"
     * @param the generated name should be unique and follow the rule: ownerName (name of the owning
     *        NodeTypeImplementation or RelationshipTypeImplementation) + _OpenTOSCA_IA_ + the number of
     *        the implementation artifact in the list of implementation artifacts of the owning
     *        *Implementation
     *
     */
